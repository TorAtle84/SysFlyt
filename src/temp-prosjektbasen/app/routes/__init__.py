...
from app.routes.sluplan_bp import sluplan_bp
from app.routes.gk_spill_bp import gk_spill_bp
...
def register_blueprints(app):
    ...
    app.register_blueprint(sluplan_bp)
    app.register_blueprint(gk_spill_bp)
